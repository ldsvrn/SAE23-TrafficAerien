...
class ModeleForm(ModelForm):
    class Meta:
        model = models.Modele
        fields = ('nommodele', 'marquemodele', 'typemodele',
                  'descrimodele', 'imagemodele', 'longpistemodele')
        labels = {
            'nommodele': 'Nom',
            'marquemodele': 'Marque',
...
class VolForm(ModelForm):
    class Meta:
        model = models.Vol
        fields = ('idavion', 'pilotevol', 'idaeroportdepart',
                  'idaeroportarrivee', 'datedepartvol', 'datearriveevol')
        labels = {
            'idavion': 'Avion',
            'pilotevol': 'Pilote',
