...
CREATE TABLE IF NOT EXISTS `sae_23`.`avion` (
  ...
  PRIMARY KEY (`IdAvion`),
  UNIQUE INDEX `IdCompagnie_UNIQUE` (`IdCompagnie` ASC) VISIBLE,
  UNIQUE INDEX `IdModele_UNIQUE` (`IdModele` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `sae_23`.`piste` (
  ...
  PRIMARY KEY (`IdPiste`),
  UNIQUE INDEX `IdAeroport_UNIQUE` (`IdAeroport` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `sae_23`.`vol` (
  ...
  PRIMARY KEY (`IdVol`),
  UNIQUE INDEX `IdAeroportDepart_UNIQUE` (`IdAeroportDepart` ASC) VISIBLE,
  UNIQUE INDEX `IdAeroportArrivee_UNIQUE` (`IdAeroportArrivee` ASC) VISIBLE,
